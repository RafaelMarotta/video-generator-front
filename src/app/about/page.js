          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-gray-600">Mercado Livre • nov de 2023 - presente</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold">Desenvolvedor Pleno</h3>
                <p className="text-gray-600">Inter • out de 2021 - nov de 2023</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold">Desenvolvedor Jr</h3>
                <p className="text-gray-600">Tangerino • fev de 2020 - out de 2020</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-gray-600">PUC Minas • 2020 - 2025</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold">Técnico em Informática</h3>
                <p className="text-gray-600">COTEMIG • 2017 - 2019</p>
              </div>
            </div>
          </div>
